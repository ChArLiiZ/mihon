...
class GetPagePreviews(
    ...
    suspend fun await(manga: Manga, source: Source, page: Int): Result {
        val pagePreviewSource = source as? PagePreviewSource ?: return Result.Unused
        ...
        return try {
            val pagePreviews = try {
                ...
                pagePreviewSource.getPagePreviewList(manga.toSManga(), chapters.map { it.toSChapter() }, page).also {
