...
class GalleryAdder(
        ...
        try {
            ...
            val source = if (forceSource != null) {
                try {
                    ...
                    Log.e(TAG, context.stringResource(SYMR.strings.gallery_adder_source_uri_must_match), e)
            ...
            val realChapterUrl = try {
                ...
                Log.e(TAG, context.stringResource(SYMR.strings.gallery_adder_uri_map_to_chapter_error), e)
                null
            }
            ...
            val cleanedChapterUrl = if (realChapterUrl != null) {
                try {
                    ...
                    Log.e(TAG, context.stringResource(SYMR.strings.gallery_adder_uri_clean_error), e)
                    null
                }
            } else {
                null
            ...
            val realMangaUrl = try {
                ...
                Log.e(TAG, context.stringResource(SYMR.strings.gallery_adder_uri_map_to_gallery_error), e)
                null
            } ?: return GalleryAddEvent.Fail.UnknownType(url, context)
            ...
            var manga = getMangaByUrlAndSourceId.await(cleanedMangaUrl, source.id)
                ?: networkToLocalManga(
                    Manga.create().copy(
                        source = source.id,
                        url = cleanedMangaUrl,
            ...
            Log.w(TAG, context.stringResource(SYMR.strings.gallery_adder_could_not_add_gallery, url), e)
    ...
    companion object {
        private const val TAG = "GalleryAdder"
    }
}
...
sealed class GalleryAddEvent {
    ...
    class Success(
        ...
        override val logMessage = context.stringResource(SYMR.strings.gallery_adder_importing_gallery, galleryTitle)
    }
